...
namespace CG
{
	...
	void ControlWindow::Display()
	{
		ImGui::Begin("Control");
		{
			...
			// Define the values where you want the pins to live
			std::vector<float> my_pins = { 0.0f, 25.0f, 50.0f, 75.0f, 100.0f };

			// Render the custom widget
			SliderFloatWithPins("Volume", &my_value, 0.0f, 100.0f, my_pins, 0.05f);
